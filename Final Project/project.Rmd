...
knitr::include_graphics('/home/mkosko/PycharmProjects/machineLearning/Histogram Comparison.png')
```
...
```{r features, echo=FALSE,out.width="49%", out.height="20%",fig.cap="caption",fig.show='hold',fig.align='center'}
