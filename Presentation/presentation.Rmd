...
## Solver
- Rather than stochastic gradient descent, use `L-BFGS` solver (imited memory Broyden–Fletcher–Goldfarb–Shanno) [@aggarwal2018neural, p. 148]
...
```{r our-mlp, out.width="85%", fig.align='center', fig.cap = "Chosen MLP"}
